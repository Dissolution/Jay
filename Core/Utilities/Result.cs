...
namespace Jay
{
    ...
    {
        public static implicit operator Result(bool pass) => pass ? True : False;
        public static implicit operator Result(Exception? exception) => new Result(false, exception);
        ...
        internal static readonly Result False = default(Result);
