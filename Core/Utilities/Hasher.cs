...
public ref struct Hasher
{
    ...
    internal static int GetNextLargerPrime(int minimum)
    {
        ...
        for (int j = minimum | 1; j < int.MaxValue; j += 2)
        {
    ...
    private static readonly uint _seed;
    ...
    static Hasher()
    {
        ...
        _seed = BitConverter.ToUInt32(bytes);
    }
