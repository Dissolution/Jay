...
public static class TimeSpanExtensions
{
                                ...
                                IFormatProvider? formatProvider = default)
    {
        ...
        while (i < formatLen)
        {
            ...
            else
            {
                ...
                {
                    // Single char escape
                    text.Append(slash).Write(literal[0]);
                }
                else
                {
                    // Literal escape
        ...
        return timeSpan.ToString(text.ToString(), formatProvider);
    }
    ...
    public static string Format(this TimeSpan? timeSpan, 
                                ...
                                IFormatProvider? formatProvider = default)
    {
        return timeSpan is null ? "" : Format(timeSpan.Value, format, formatProvider);
    }
