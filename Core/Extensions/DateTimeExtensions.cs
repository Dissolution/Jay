...
public static class DateTimeExtensions
{
    ...
    public static TimeSpan? ElapsedSince(this DateTime? dateTime)
    {
        if (dateTime is null)
            return null;
        return ElapsedSince(dateTime.Value);
    }
    ...
    public static DateTime? AsKind(this DateTime? dateTime, DateTimeKind kind)
    {
        if (dateTime is null)
            return null;
        return AsKind(dateTime.Value, kind);
    }
    ...
    {
        return MonthStart(dateTime).AddMonths(1).AddTicks(-1);
    }
    ...
    {
        return YearStart(dateTime).AddYears(1).AddTicks(-1);
    }
    #endregion
