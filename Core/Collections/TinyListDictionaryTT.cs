...
namespace Jay.Collections
{
    public readonly struct Entry<TKey, TValue> : IEquatable<Entry<TKey, TValue>>
    {
        ...
        public static bool operator !=(Entry<TKey, TValue> left, Entry<TKey, TValue> right) => !(left == right);
        ...
        {
            return EqualityComparer<TKey>.Default.Equals(Key, entry.Key) && 
        ...
        {
            return obj is Entry<TKey, TValue> entry && Equals(entry);
        }

        /// <inheritdoc />
        public override int GetHashCode() => Hasher.Create(Key, Value);
    }
