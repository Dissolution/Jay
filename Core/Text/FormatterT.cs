...
namespace Jay.Text
{
    ...
    internal readonly struct FormatMethods : IEquatable<FormatMethods>
    {
        ...
        {
            return obj is FormatMethods other && Equals(other);
        }

        /// <inheritdoc />
        public override int GetHashCode()
        {
            return HashCode.Combine(ObjectType, TryFormatObject, FormatObject);
        }
    ...
    public static class Formatter
    {
        ...
        private static FormatMethods CreateFormatMethods(Type type)
        {
            ...
            var tryFormatMethods = type.GetMethods(Reflect.InstanceFlags)
                                       ...
                                       .OrderByDescending(MethodComplexityComparer.Instance)
                                       .ToList();
