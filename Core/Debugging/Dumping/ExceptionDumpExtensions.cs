...
namespace Jay.Debugging.Dumping
{
    public static class ExceptionDumpExtensions
    {
                                             ...
                                             DumpOptions? options = default)
        {
            ...
            textBuilder.AppendDump(exceptionType, options).Append(':').AppendLine();
            // Message
            textBuilder.Append("-Message: ").Append(exception.Message).AppendLine();
            ...
            if (data != null)
            {
                if (data.Count > 0)
                {
                    textBuilder.Append("-Data:").AppendLine()
            ...
            if (exception is AggregateException aggregateException)
            {
                ...
                {
                    textBuilder.Append("-InnerExceptions:").AppendLine()
            ...
            else
            {
                ...
                {
                    textBuilder.Append("-InnerException:").AppendLine()
            ...
            {
                textBuilder.Append("-StackTrace:").AppendLine()
