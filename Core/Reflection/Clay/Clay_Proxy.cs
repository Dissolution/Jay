...
namespace Jay.Reflection
{
    internal sealed class InterfaceWrapperFactory
    {
        ...
        {
            _memberInfoComparer = new FuncBasedComparer<MemberInfo>((a, b) => a.MemberType.CompareTo(b.MemberType));
        }
        ...
        public InterfaceWrapperFactory(Type sourceType, Type destType)
        {
            ...
            _memberBuilders = new Dictionary<MemberInfo, object>(MemberInfoEqualityComparer.Instance);
		...
		private EventBuilder ImplementEvent(EventInfo @event)
		{
