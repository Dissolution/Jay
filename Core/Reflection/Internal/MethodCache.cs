...
internal static class MethodCache
{
    ...
    static MethodCache()
    {
        _runtimeHelpers_GetUninitializedObject_Method = new Lazy<MethodInfo>(() =>
        {
            ...
            if (method is null)
                throw new RuntimeException(
                    $"Cannot find {nameof(RuntimeHelpers)}.{nameof(RuntimeHelpers.GetUninitializedObject)}({nameof(Type)})");
            return method;
        });
        _type_GetTypeFromHandle_Method = new Lazy<MethodInfo>(() =>
        {
            ...
            if (method is null)
                throw new RuntimeException(
                    $"Cannot find {nameof(Type)}.{nameof(Type.GetTypeFromHandle)}({nameof(RuntimeTypeHandle)})");
            return method;
        });
        _multicastDelegate_GetInvocationList_Method = new Lazy<MethodInfo>(() =>
        {
            ...
            if (method is null)
                throw new RuntimeException(
                    $"Cannot fine {nameof(MulticastDelegate)}.{nameof(Delegate.GetInvocationList)}()");
            return method;
        });
        ...
        _delegate_Combine_Method = new Lazy<MethodInfo>(() =>
        {
            ...
            if (method is null)
                throw new RuntimeException(
                    $"Cannot fine {nameof(Delegate)}.{nameof(Delegate.Combine)}({nameof(Delegate)},{nameof(Delegate)})");
            return method;
        });
        _delegate_Remove_Method = new Lazy<MethodInfo>(() =>
        {
            ...
            if (method is null)
                throw new RuntimeException(
                    $"Cannot find {nameof(Delegate)}.{nameof(Delegate.Remove)}({nameof(Delegate)},{nameof(Delegate)})");
            return method;
        });
    }
}