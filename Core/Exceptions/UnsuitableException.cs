...
namespace Jay.Exceptions
{
    ...
    {
        public static UnsuitableException GetHashCode<T>(T? instance = default)
        {
            return new UnsuitableException(typeof(T), $"Type '{typeof(T)}' is unsuitable for hashing");
        }
        ...
        public static UnsuitableException Equals<T>(T? instance = default)
        {
