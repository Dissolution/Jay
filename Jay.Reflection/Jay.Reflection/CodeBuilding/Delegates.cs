...
/// </summary>
/// <typeparam name="T">
/// The <see cref="Type"/> of <paramref name="value"/> to build with
/// </typeparam>
/// <param name="codeBuilder">
/// The <see cref="CodeBuilder"/> to build upon
/// </param>
/// <param name="value">
/// The <typeparamref name="T"/> value to build with
/// </param>
public delegate void CBVA<in T>(CodeBuilder codeBuilder, T value);

/// <summary>
/// <b>C</b>ode <b>B</b>uilder <b>T</b>ext <b>A</b>ction <br/>
/// <see cref="Action{T, T}">Action&lt;CodeBuilder, ReadOnlySpan&lt;char&gt;&gt;</see>
/// </summary>
/// <param name="codeBuilder">The <see cref="CodeBuilder"/> to build upon</param>
/// <param name="text">The <see cref="ReadOnlySpan{T}">ReadOnlySpan&lt;char&gt;</see> value to build with</param>
public delegate void CBTA(CodeBuilder codeBuilder, ReadOnlySpan<char> text);

/// <summary>
/// <b>C</b>ode <b>B</b>uilder <b>I</b>ndexed <b>V</b>alue <b>A</b>ction <br/>
/// <see cref="Action{T, T, T}">Action&lt;CodeBuilder, T, int&gt;</see>
/// </summary>
...
public delegate void CBIVA<in T>(CodeBuilder codeBuilder, T value, int index);
