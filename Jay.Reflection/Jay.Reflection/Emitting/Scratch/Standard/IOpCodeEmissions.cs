    ...
    where Self : IEmitter<Self>
{
    ...
    Self Emit(OpCode opCode, byte arg);
    ...
    Self Emit(OpCode opCode, sbyte arg);
    ...
    Self Emit(OpCode opCode, short arg);
    ...
    Self Emit(OpCode opCode, int arg);
    ...
    Self Emit(OpCode opCode, long arg);
    ...
    Self Emit(OpCode opCode, float arg);
    ...
    Self Emit(OpCode opCode, double arg);
    ...
    Self Emit(OpCode opCode, string str);
    ...
    Self Emit(OpCode opCode, EmitterLabel label);
    ...
    Self Emit(OpCode opCode, params EmitterLabel[] labels);
    ...
    Self Emit(OpCode opCode, EmitterLocal emitterLocal);
    ...
    Self Emit(OpCode opCode, FieldInfo field);
    ...
    Self Emit(OpCode opCode, ConstructorInfo ctor);
    ...
    Self Emit(OpCode opCode, MethodInfo method);
    ...
    Self Emit(OpCode opCode, Type type);
    ...
    Self Emit(OpCode opCode, SignatureHelper signature);
}