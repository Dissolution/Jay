...
public sealed class TryCatchFinallyEmitter<TEmitter>
    where TEmitter : FluentEmitter<TEmitter>
{
    ...
    public TryCatchFinallyEmitter<TEmitter> Catch<TException>(Action<TEmitter> catchBlock)
    ...
    /// <param name="catchBlock">The instructions to emit during this <c>catch</c> block</param>
    /// <returns>This <see cref="TryCatchFinallyEmitter{TEmitter}"/></returns>
    public TryCatchFinallyEmitter<TEmitter> Catch(Type exceptionType, Action<TEmitter> catchBlock)
    {
