...
public ref struct InterpolatedText
{
    ...
    /// <summary>
    /// Gets a <see cref="Span{T}">Span&lt;char&gt;</see> of written characters
    /// </summary>
    ...
    /// <summary>
    /// Gets a <see cref="Span{T}">Span&lt;char&gt;</see> of available characters
    /// </summary>
    ...
    /// Note: Will be increased as necessary
    /// </summary>
    public int Capacity
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
#region Interpolated String Handler implementations
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public void AppendFormatted<T>(T value, scoped ReadOnlySpan<char> format) => Write<T>(value, format);
#endregion
